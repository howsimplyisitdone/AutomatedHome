package cf.howsimplyisitdone.esp8266;
...
public class MainActivity extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.i(TAG, "Buttons have been defined");

        // assign text inputs
        editTextIPAddress = (EditText)findViewById(R.id.editTextIPAddress);
        editTextPortNumber = (EditText)findViewById(R.id.editTextPortNumber);
        Log.i(TAG, "IP and Port have been defined");
    ...
    public void onClick(View view) {
        ...
        Log.i(TAG, "IP is " + ipAddress);
        // get the port number
        String portNumber = editTextPortNumber.getText().toString().trim();
        Log.i(TAG, "Port is " + portNumber);
        ...
        {
            parameterValue = "1"; //Pin 11
        }
        else if(view.getId()==buttonPin12.getId())
        {
            parameterValue = "2"; // Pin 12
        }
        else
        {
            parameterValue = "3"; // Pin 13
        }
        Log.i(TAG, "Parameter is " + parameterValue);
    ...
    public String sendRequest(String parameterValue, String ipAddress, String portNumber, String parameterName) {
        ...
        try {
            ...
            HttpClient httpclient = new DefaultHttpClient(httpParameters); // create an HTTP client
            //HttpURLConnection httpclient = (HttpURLConnection) url.openConnection();
            // define the URL e.g. http://myIpaddress:myport/?pin=13 (to toggle pin 13 for example)
            //URI website = new URI("http://"+ipAddress+":"+portNumber+"/?"+parameterName+"="+parameterValue);

            URI website = new URI("http://"+ipAddress+":"+portNumber+"/?"+parameterName+parameterValue);
            Log.i(TAG, "Sending " +ipAddress+":"+portNumber+"/?"+parameterName+parameterValue);
